...
namespace SocketSharp
{
    class Program
    {
        ...
        public class Message
        {
            ...
            public int ReceiveHeaders(ref Socket s)
            {
            ...
            {
                m_Header.m_To = ReceiveHeaders(ref s);
                m_Header.m_From = ReceiveHeaders(ref s);
                m_Header.m_Type = ReceiveHeaders(ref s);
                m_Header.m_Size = ReceiveHeaders(ref s);
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.WriteLine("1. Send to Id\n 2. Send to ALL\n 3. Exit");
                int n;
